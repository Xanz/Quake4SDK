...
#define KMOVDS1(DST, SRC0) \
	__asm movss xmm2, SRC0 __asm movss DST, xmm2
#define KMOVDS4(DST, SRC0) \
	__asm movups xmm2, SRC0 __asm movups DST, xmm2
#define KMINDS1(DST, SRC0) \
	__asm movss xmm2, SRC0 __asm minss DST, xmm2
#define KMAXDS1(DST, SRC0) \
	__asm movss xmm2, SRC0 __asm maxss DST, xmm2

// general ALU operation
#define KALUDSS1(OP, DST, SRC0, SRC1) \
	__asm movss xmm2, SRC0 __asm OP##ss xmm2, SRC1 __asm movss DST, xmm2
#define KALUDSS4(OP, DST, SRC0, SRC1) \
	__asm movups xmm2, SRC0 __asm movups xmm3, SRC1 __asm OP##ps xmm2, xmm3 __asm movups DST, xmm2
...
#define KDIVDSS1(DST, SRC0, SRC1) \
	__asm movss xmm2, SRC1 __asm rcpss xmm3, xmm2 __asm mulss xmm2, xmm3 __asm mulss xmm2, xmm3 __asm addss xmm3, xmm3 __asm subss xmm3, xmm2 __asm mulss xmm3, SRC0 __asm movss DST, xmm3
#define KDIVDSS4(DST, SRC0, SRC1) \
	__asm movups xmm2, SRC1 __asm rcpps xmm3, xmm2 __asm mulps xmm2, xmm3 __asm mulps xmm2, xmm3 __asm addps xmm3, xmm3 __asm subps xmm3, xmm2 __asm movups xmm2, SRC0 __asm mulps xmm3, xmm2 __asm movups DST, xmm3
#define KF2IDS1(SRC0) \
	__asm movss xmm2, SRC0 __asm cvttps2pi mm2, xmm2 __asm movd[edi + ebx], mm2
#define KF2IDS4(SRC0) \
	__asm movups xmm2, SRC0 __asm cvttps2pi mm2, xmm2 __asm movq[edi + ebx + 0], mm2 __asm shufps xmm2, xmm2, SHUFFLE_PS(1, 0, 3, 2) __asm cvttps2pi mm2, xmm2 __asm movq[edi + ebx + 8], mm2
#define KISQRTDS1(DST, SRC0) \
	__asm movss xmm2, SRC0 __asm rsqrtss xmm3, xmm2 __asm mulss xmm2, xmm3 __asm mulss xmm2, xmm3 __asm subss xmm2, xmm1 __asm mulss xmm3, xmm0 __asm mulss xmm3, xmm2 __asm movss DST, xmm3
#define KISQRTDS4(DST, SRC0) \
	__asm movups xmm2, SRC0 __asm rsqrtps xmm3, xmm2 __asm mulps xmm2, xmm3 __asm mulps xmm2, xmm3 __asm subps xmm2, xmm1 __asm mulps xmm3, xmm0 __asm mulps xmm3, xmm2 __asm movups DST, xmm3

// this is used in vector4 implementation to shift constant V4
#define KANDREGDSV(DST, SRC0, VALUE) \
	__asm mov DST, SRC0 __asm and DST, VALUE

// this is used in vector4 code to operate with float arrays as sources
#define KEXPANDFLOAT(DST, SRC) \
	__asm movss DST, SRC __asm shufps DST, DST, 0
...
#define SINGLE_OP(SRC, DEST) \
	__asm movlps xmm0, [SRC] __asm movlps xmm1, [SRC + 8] __asm mulps xmm0, xmm4 __asm mulps xmm1, xmm5 __asm addps xmm0, xmm1 __asm movaps xmm1, xmm0 __asm shufps xmm1, xmm1, SHUFFLE_PS(1, 1, 1, 1) __asm addss xmm0, xmm1 __asm movss[DEST], xmm0 __asm add SRC, 16 __asm add DEST, 4

#define DUAL_OP(SRC, DEST) \
	__asm movlps xmm0, [SRC] __asm movlps xmm1, [SRC + 8] __asm movhps xmm0, [SRC + 16] __asm movhps xmm1, [SRC + 24] __asm mulps xmm0, xmm4 __asm mulps xmm1, xmm5 __asm addps xmm0, xmm1 __asm shufps xmm1, xmm0, SHUFFLE_PS(2, 0, 1, 0) __asm shufps xmm0, xmm0, SHUFFLE_PS(3, 1, 2, 0) __asm addps xmm0, xmm1 __asm movhps[DEST], xmm0 __asm add SRC, 32 __asm add DEST, 8
...
#define STORE4(offset, reg1, reg2) \
	__asm movlps[eax + offset], reg1 __asm movhps[eax + offset + 8], reg1
#define STOREC =
...
{
#define STORE1(offset, reg1, reg2) \
	__asm movss reg2, [eax + offset] __asm addss reg2, reg1 __asm movss[eax + offset], reg2
#define STORE2LO(offset, reg1, reg2) \
	__asm movlps reg2, [eax + offset] __asm addps reg2, reg1 __asm movlps[eax + offset], reg2
#define STORE2HI(offset, reg1, reg2) \
	__asm movhps reg2, [eax + offset] __asm addps reg2, reg1 __asm movhps[eax + offset], reg2
#define STORE4(offset, reg1, reg2) \
	__asm movlps reg2, [eax + offset] __asm movhps reg2, [eax + offset + 8] __asm addps reg2, reg1 __asm movlps[eax + offset], reg2 __asm movhps[eax + offset + 8], reg2
#define STOREC +=
...
{
#define STORE1(offset, reg1, reg2) \
	__asm movss reg2, [eax + offset] __asm subss reg2, reg1 __asm movss[eax + offset], reg2
#define STORE2LO(offset, reg1, reg2) \
	__asm movlps reg2, [eax + offset] __asm subps reg2, reg1 __asm movlps[eax + offset], reg2
#define STORE2HI(offset, reg1, reg2) \
	__asm movhps reg2, [eax + offset] __asm subps reg2, reg1 __asm movhps[eax + offset], reg2
#define STORE4(offset, reg1, reg2) \
	__asm movlps reg2, [eax + offset] __asm movhps reg2, [eax + offset + 8] __asm subps reg2, reg1 __asm movlps[eax + offset], reg2 __asm movhps[eax + offset + 8], reg2
#define STOREC -=
...
void VPCALL idSIMD_SSE::MatX_MultiplyMatX(idMatX &dst, const idMatX &m1, const idMatX &m2)
{
	...
	case 1:
	{
		if (!(l ^ 6))
		{
			...
			{
			case 1:
			{ // 1x1 * 1x6, no precision loss compared to FPU version
				__asm {
							mov			esi, m2Ptr
							mov			edi, m1Ptr
							mov			eax, dstPtr
			...
			case 6:
			{ // 6x1 * 1x6, no precision loss compared to FPU version
				__asm {
							mov			esi, m2Ptr
							mov			edi, m1Ptr
							mov			eax, dstPtr
...
#define MUL_Nx4_4x6_FIRST4COLUMNS_INIT \
	__asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax, dstPtr __asm movlps xmm0, [esi + 0 * 4] __asm movhps xmm0, [esi + 2 * 4] __asm movlps xmm1, [esi + 6 * 4] __asm movhps xmm1, [esi + 8 * 4] __asm movlps xmm2, [esi + 12 * 4] __asm movhps xmm2, [esi + 14 * 4] __asm movlps xmm3, [esi + 18 * 4] __asm movhps xmm3, [esi + 20 * 4]

#define MUL_Nx4_4x6_FIRST4COLUMNS_ROW(row) \
	__asm movss xmm4, [edi + row * 16 + 0 * 4] __asm shufps xmm4, xmm4, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm4, xmm0 __asm movss xmm5, [edi + row * 16 + 1 * 4] __asm shufps xmm5, xmm5, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm5, xmm1 __asm addps xmm4, xmm5 __asm movss xmm6, [edi + row * 16 + 2 * 4] __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm6, xmm2 __asm addps xmm4, xmm6 __asm movss xmm7, [edi + row * 16 + 3 * 4] __asm shufps xmm7, xmm7, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm7, xmm3 __asm addps xmm4, xmm7 __asm movlps[eax + row * 24 + 0], xmm4 __asm movhps[eax + row * 24 + 8], xmm4

#define MUL_Nx4_4x6_LAST2COLUMNS_INIT \
	__asm movlps xmm0, [esi + 4 * 4] __asm movlps xmm1, [esi + 10 * 4] __asm movlps xmm2, [esi + 16 * 4] __asm movlps xmm3, [esi + 22 * 4] __asm shufps xmm0, xmm1, R_SHUFFLE_PS(0, 1, 0, 1) __asm shufps xmm1, xmm0, R_SHUFFLE_PS(0, 1, 0, 1) __asm shufps xmm2, xmm3, R_SHUFFLE_PS(0, 1, 0, 1) __asm shufps xmm3, xmm2, R_SHUFFLE_PS(0, 1, 0, 1)

#define MUL_Nx4_4x6_LAST2COLUMNS_ROW2(row) \
	__asm movlps xmm7, [edi + row * 32 + 0 * 4] __asm movhps xmm7, [edi + row * 32 + 4 * 4] __asm movaps xmm6, xmm7 __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 3, 3) __asm mulps xmm6, xmm0 __asm shufps xmm7, xmm7, R_SHUFFLE_PS(1, 1, 2, 2) __asm mulps xmm7, xmm1 __asm addps xmm6, xmm7 __asm movlps xmm4, [edi + row * 32 + 2 * 4] __asm movhps xmm4, [edi + row * 32 + 6 * 4] __asm movaps xmm5, xmm4 __asm shufps xmm5, xmm5, R_SHUFFLE_PS(0, 0, 3, 3) __asm mulps xmm5, xmm2 __asm addps xmm6, xmm5 __asm shufps xmm4, xmm4, R_SHUFFLE_PS(1, 1, 2, 2) __asm mulps xmm4, xmm3 __asm addps xmm6, xmm4 __asm movlps[eax + row * 48 + 4 * 4], xmm6 __asm movhps[eax + row * 48 + 10 * 4], xmm6
...
#define MUL_Nx6_6x3_INIT \
	__asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax, dstPtr __asm movss xmm0, [esi + 0 * 4] __asm movhps xmm0, [esi + 1 * 4] __asm movss xmm1, [esi + 3 * 4] __asm movhps xmm1, [esi + 4 * 4] __asm movss xmm2, [esi + 6 * 4] __asm movhps xmm2, [esi + 7 * 4] __asm movss xmm3, [esi + 9 * 4] __asm movhps xmm3, [esi + 10 * 4] __asm movss xmm4, [esi + 12 * 4] __asm movhps xmm4, [esi + 13 * 4] __asm movss xmm5, [esi + 15 * 4] __asm movhps xmm5, [esi + 16 * 4]

#define MUL_Nx6_6x3_ROW(row) \
	__asm movss xmm7, [edi + row * 24 + 0] __asm shufps xmm7, xmm7, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm7, xmm0 __asm movss xmm6, [edi + row * 24 + 4] __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm6, xmm1 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + row * 24 + 8] __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm6, xmm2 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + row * 24 + 12] __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm6, xmm3 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + row * 24 + 16] __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm6, xmm4 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + row * 24 + 20] __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm6, xmm5 __asm addps xmm7, xmm6 __asm movss[eax + row * 12 + 0], xmm7 __asm movhps[eax + row * 12 + 4], xmm7
...
#define MUL_Nx6_6x4_INIT \
	__asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax, dstPtr __asm movaps xmm0, [esi] __asm movaps xmm1, [esi + 16] __asm movaps xmm2, [esi + 32] __asm movaps xmm3, [esi + 48] __asm movaps xmm4, [esi + 64] __asm movaps xmm5, [esi + 80]

#define MUL_Nx6_6x4_ROW(row) \
	__asm movss xmm7, [edi + row * 24 + 0] __asm shufps xmm7, xmm7, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm7, xmm0 __asm movss xmm6, [edi + row * 24 + 4] __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm6, xmm1 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + row * 24 + 8] __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm6, xmm2 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + row * 24 + 12] __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm6, xmm3 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + row * 24 + 16] __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm6, xmm4 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + row * 24 + 20] __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm6, xmm5 __asm addps xmm7, xmm6 __asm movaps[eax + row * 16], xmm7
...
#define MUL_2xN_2x2_INIT \
	__asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax, dstPtr __asm movlps xmm0, [esi] __asm shufps xmm0, xmm0, R_SHUFFLE_PS(0, 1, 0, 1) __asm movlps xmm1, [esi + 8] __asm shufps xmm1, xmm1, R_SHUFFLE_PS(0, 1, 0, 1)

#define MUL_2xN_2x2_ROW2(N, row) \
	__asm movlps xmm6, [edi + (row + 0 * N) * 4] __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 1, 1) __asm movlps xmm7, [edi + (row + 1 * N) * 4] __asm shufps xmm7, xmm7, R_SHUFFLE_PS(0, 0, 1, 1) __asm mulps xmm6, xmm0 __asm mulps xmm7, xmm1 __asm addps xmm6, xmm7 __asm movaps[eax + (row * 2) * 4], xmm6
...
#define MUL_4xN_4x4_INIT \
	__asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax, dstPtr __asm movaps xmm0, [esi] __asm movaps xmm1, [esi + 16] __asm movaps xmm2, [esi + 32] __asm movaps xmm3, [esi + 48]

#define MUL_4xN_4x4_ROW(N, row) \
	__asm movss xmm7, [edi + (row + 0 * N) * 4] __asm shufps xmm7, xmm7, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm7, xmm0 __asm movss xmm6, [edi + (row + 1 * N) * 4] __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm6, xmm1 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + (row + 2 * N) * 4] __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm6, xmm2 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + (row + 3 * N) * 4] __asm shufps xmm6, xmm6, R_SHUFFLE_PS(0, 0, 0, 0) __asm mulps xmm6, xmm3 __asm addps xmm7, xmm6 __asm movaps[eax + row * 16], xmm7
