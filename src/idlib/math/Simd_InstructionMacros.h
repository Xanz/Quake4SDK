...
#define ADDRESS_ADD_C(reg0, constant) 0x40 | (reg0 & 7) _asm _emit constant

#define ADDRESS_ADD_LC(reg0, constant) 0x80 | (reg0 & 7) _asm _emit(((constant) >> 0) & 255) _asm _emit(((constant) >> 8) & 255) _asm _emit(((constant) >> 16) & 255) _asm _emit(((constant) >> 24) & 255)

#define ADDRESS_ADD_R(reg0, reg1) 0x04 _asm _emit((reg1 & 7) << 3) | (reg0 & 7)

#define ADDRESS_ADD_RC(reg0, reg1, constant) 0x44 _asm _emit((reg1 & 7) << 3) | (reg0 & 7) _asm _emit constant

#define ADDRESS_ADD_RLC(reg0, reg1, constant) 0x84 _asm _emit((reg1 & 7) << 3) | (reg0 & 7) _asm _emit(((constant) >> 0) & 255) _asm _emit(((constant) >> 8) & 255) _asm _emit(((constant) >> 16) & 255) _asm _emit(((constant) >> 24) & 255)

#define ADDRESS_ADD_RS(reg0, reg1, scale) 0x04 _asm _emit((reg1 & 7) << 3) | (reg0 & 7) | RSCALE(scale)

#define ADDRESS_ADD_RSC(reg0, reg1, scale, constant) 0x44 _asm _emit((reg1 & 7) << 3) | (reg0 & 7) | RSCALE(scale) _asm _emit constant

#define ADDRESS_ADD_RSLC(reg0, reg1, scale, constant) 0x84 _asm _emit((reg1 & 7) << 3) | (reg0 & 7) | RSCALE(scale) _asm _emit(((constant) >> 0) & 255) _asm _emit(((constant) >> 8) & 255) _asm _emit(((constant) >> 16) & 255) _asm _emit(((constant) >> 24) & 255)
...
#define _cmpps(dst, src, cond) \
	_asm _emit 0x0F _asm _emit 0xC2 _asm _emit((dst & 7) << 3) | src _asm _emit cond
...
#define _cmpss(dst, src, cond) \
	_asm _eint 0xF3 _asm _emit 0x0F _asm _emit 0xC2 _asm _emit((dst & 7) << 3) | src _asm _emit cond
...
#define TRANSPOSE_4x4(reg0, reg1, reg2, reg3, reg4)                \
	__asm movaps reg4, reg2 /* reg4 =  8,  9, 10, 11 */            \
		...
		reg0 /* reg1 =  0,  4,  1,  5 */                           \
		__asm shufps reg0,                                         \
		reg2, R_SHUFFLE_PS(0, 1, 0, 1) /* reg0 =  0,  4,  8, 12 */ \
		__asm shufps reg1,                                         \
		reg2, R_SHUFFLE_PS(2, 3, 2, 3) /* reg1 =  1,  5,  9, 13 */ \
		__asm movaps reg2,                                         \
		reg3 /* reg2 =  2,  6,  3,  7 */                           \
		__asm shufps reg2,                                         \
		reg4, R_SHUFFLE_PS(0, 1, 0, 1) /* reg2 =  2,  6, 10, 14 */ \
		__asm shufps reg3,                                         \
		reg4, R_SHUFFLE_PS(2, 3, 2, 3) /* reg3 =  3,  7, 11, 15 */
...
#define TRANPOSE_4x4_FROM_MEMORY(address, reg0, reg1, reg2, reg3, reg4) \
	__asm movlps reg1, [address + 0] /* reg1 =  0,  1,  X,  X */        \
		__asm movlps reg3,                                              \
		[address + 8] /* reg3 =  2,  3,  X,  X */                       \
		__asm movhps reg1,                                              \
		[address + 16] /* reg1 =  0,  1,  4,  5 */                      \
		__asm movhps reg3,                                              \
		[address + 24] /* reg3 =  2,  3,  6,  7 */                      \
		__asm movlps reg2,                                              \
		[address + 32] /* reg2 =  8,  9,  X,  X */                      \
		__asm movlps reg4,                                              \
		[address + 40] /* reg4 = 10, 11,  X,  X */                      \
		__asm movhps reg2,                                              \
		[address + 48] /* reg2 =  8,  9, 12, 13 */                      \
		__asm movhps reg4,                                              \
		[address + 56] /* reg4 = 10, 11, 14, 15 */                      \
		__asm movaps reg0,                                              \
		reg1 /* reg0 =  0,  1,  4,  5 */                                \
		__asm shufps reg0,                                              \
		reg2, R_SHUFFLE_PS(0, 2, 0, 2) /* reg0 =  0,  4,  8, 12 */      \
		__asm shufps reg1,                                              \
		reg2, R_SHUFFLE_PS(1, 3, 1, 3) /* reg1 =  1,  5,  9, 13 */      \
		__asm movaps reg2,                                              \
		reg3 /* reg2 =  2,  3,  6,  7 */                                \
		__asm shufps reg2,                                              \
		reg4, R_SHUFFLE_PS(0, 2, 0, 2) /* reg2 =  2,  6, 10, 14 */      \
		__asm shufps reg3,                                              \
		reg4, R_SHUFFLE_PS(1, 3, 1, 3) /* reg3 =  3,  7, 11, 15 */
...
#define TRANPOSE_4x4_TO_MEMORY(address, reg0, reg1, reg2, reg3, reg4) \
	__asm movaps reg4, reg0 /* reg4 =  0,  4,  8, 12 */               \
		...
		reg3 /* reg2 =  2,  3,  6,  7 */                              \
		__asm unpckhps reg1,                                          \
		reg3 /* reg1 = 10, 11, 14, 15 */                              \
		__asm movlps[address + 0],                                    \
		reg0 /* mem0 =  0,  1,  X,  X */                              \
		__asm movlps[address + 8],                                    \
		reg2 /* mem0 =  0,  1,  2,  3 */                              \
		__asm movhps[address + 16],                                   \
		reg0 /* mem1 =  4,  5,  X,  X */                              \
		__asm movhps[address + 24],                                   \
		reg2 /* mem1 =  4,  5,  6,  7 */                              \
		__asm movlps[address + 32],                                   \
		reg4 /* mem2 =  8,  9,  X,  X */                              \
		__asm movlps[address + 40],                                   \
		reg1 /* mem2 =  8,  9, 10, 11 */                              \
		__asm movhps[address + 48],                                   \
		reg4 /* mem3 = 12, 13,  X,  X */                              \
		__asm movhps[address + 56],                                   \
		reg1 /* mem3 = 12, 13, 14, 15 */
...
#define TRANSPOSE_4x3(reg0, reg1, reg2, reg3)                      \
	__asm movaps reg3, reg2 /* reg3 =  8,  9, 10, 11 */            \
		__asm shufps reg3,                                         \
		reg1, R_SHUFFLE_PS(2, 3, 0, 1) /* reg3 = 10, 11,  4,  5 */ \
		__asm shufps reg2,                                         \
		reg0, R_SHUFFLE_PS(0, 1, 2, 3) /* reg2 =  8,  9,  2,  3 */ \
		__asm shufps reg1,                                         \
		reg0, R_SHUFFLE_PS(2, 3, 0, 1) /* reg1 =  6,  7,  0,  1 */ \
		__asm movaps reg0,                                         \
		reg1 /* reg0 =  6,  7,  0,  1 */                           \
		__asm shufps reg0,                                         \
		reg2, R_SHUFFLE_PS(2, 0, 3, 1) /* reg0 =  0,  6,  3,  9 */ \
		__asm shufps reg1,                                         \
		reg3, R_SHUFFLE_PS(3, 1, 2, 0) /* reg1 =  1,  7,  4, 10 */ \
		__asm shufps reg2,                                         \
		reg3, R_SHUFFLE_PS(2, 0, 3, 1) /* reg2 =  2,  8,  5, 11 */
...
#define TRANSPOSE_4x3_FROM_MEMORY(address, reg0, reg1, reg2, reg3) \
	__asm movlps reg1, [address + 0] /* reg1 =  0,  1,  X,  X */   \
		__asm movlps reg2,                                         \
		[address + 8] /* reg2 =  2,  3,  X,  X */                  \
		__asm movlps reg3,                                         \
		[address + 16] /* reg3 =  4,  5,  X,  X */                 \
		__asm movhps reg1,                                         \
		[address + 24] /* reg1 =  0,  1,  6,  7 */                 \
		__asm movhps reg2,                                         \
		[address + 32] /* reg2 =  2,  3,  8,  9 */                 \
		__asm movhps reg3,                                         \
		[address + 40] /* reg3 =  4,  5, 10, 11 */                 \
		__asm movaps reg0,                                         \
		reg1 /* reg0 =  0,  1,  6,  7 */                           \
		__asm shufps reg0,                                         \
		reg2, R_SHUFFLE_PS(0, 2, 1, 3) /* reg0 =  0,  6,  3,  9 */ \
		__asm shufps reg1,                                         \
		reg3, R_SHUFFLE_PS(1, 3, 0, 2) /* reg1 =  1,  7,  4, 10 */ \
		__asm shufps reg2,                                         \
		reg3, R_SHUFFLE_PS(0, 2, 1, 3) /* reg2 =  2,  8,  5, 11 */
...
#define TRANSPOSE_4x3_TO_MEMORY(address, reg0, reg1, reg2, reg3) \
	__asm movhlps reg3, reg0 /* reg3 =  3,  9,  X,  X */         \
		...
		__asm movlps[address + 8],                               \
		reg2 /* mem0 =  0,  1,  2,  3 */                         \
		__asm movlps[address + 16],                              \
		reg1 /* mem1 =  4,  5,  X,  X */                         \
		__asm movhps[address + 24],                              \
		reg0 /* mem1 =  4,  5,  6,  7 */                         \
		__asm movhps[address + 32],                              \
		reg2 /* mem2 =  8,  9,  X,  X */                         \
...
#define TRANSPOSE_4x4_INT(reg0, reg1, reg2, reg3, reg4) \
	__asm movdqa reg4, reg2 /* reg4 =  8,  9, 10, 11 */ \
		__asm punpckldq reg2,                           \
		reg3 /* reg2 =  8, 12,  9, 13 */                \
		__asm punpckhdq reg4,                           \
		reg3 /* reg4 = 10, 14, 11, 15 */                \
		__asm movdqa reg3,                              \
		reg0 /* reg3 =  0,  1,  2,  3 */                \
		__asm punpckldq reg0,                           \
		reg1 /* reg0 =  0,  4,  1,  5 */                \
		__asm punpckhdq reg3,                           \
		reg1 /* reg3 =  2,  6,  3,  7 */                \
		__asm movdqa reg1,                              \
		reg0 /* reg1 =  0,  4,  1,  5 */                \
		__asm punpcklqdq reg0,                          \
		reg2 /* reg0 =  0,  4,  8, 12 */                \
		__asm punpckhqdq reg1,                          \
		reg2 /* reg1 =  1,  5,  9, 13 */                \
		__asm movdqa reg2,                              \
		reg3 /* reg2 =  2,  6,  3,  7 */                \
		__asm punpcklqdq reg2,                          \
		reg4 /* reg2 =  2,  6, 10, 14 */                \
		__asm punpckhqdq reg3,                          \
		reg4 /* reg3 =  3,  7, 11, 15 */
